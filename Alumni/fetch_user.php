...
WHERE id != '".$_SESSION['user_id']."' and clg_name='".$_SESSION['clg']."'
";
...
foreach($result as $row)
{
 ...
 <tr>
  ...
  <td>'.$status.'</td>
  <td><button type="button" class="btn btn-info btn-xs start_chat" data-touserid="'.$row['id'].'" data-tousername="'.$row['fname'].'">Start Chat</button></td>
 </tr>
 ';
}
