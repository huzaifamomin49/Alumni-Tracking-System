        ...
        <nav class="navbar-sidebar2">
            <ul class="list-unstyled navbar__list">
                ...
                <li class="active has-sub">
                    <a class="js-arrow" href="event.php">
            ...
            <div class="row">
                <div class="col-xl-8">
                    ...
                    <div class="recent-report2">
                        ...
                        <h2 class="title-3"> Announcement : </h2>
                        <marquee scrollamount=6 class="text-primary font-weight-bolder">
                        <?php
                            $sql21="Select * from announcements1 where clg_name='$clg1'";
                            $result2 = mysqli_query($db,$sql21);
                ...
                <div class="col-xl-8">
                    ...
                    <div class="recent-report2">
                        ...
                        <h2 class="title-3"> Notification : </h2>
                        <marquee scrollamount=6 class="text-primary font-weight-bolder">
                        <?php
                            $sql11="Select * from notifications1 where clg_name='$clg1'";
                ...
                <div class="col-xl-8">
                    ...
                    <div class="recent-report2">
                        ...
                        <h2 class="title-3"> Event : </h2>
                        <marquee scrollamount=6 class="text-primary font-weight-bolder">
                        <?php
                            $sql31="Select * from events1 where clg_name='$clg1'";
                            $result3 = mysqli_query($db,$sql31);
